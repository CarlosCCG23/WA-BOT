module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *WhatsApp* : https://chat.whatsapp.com/Gl0eUl2rkyq4Z06QlxfBSH *Source* : https://github.com/ you find an error or want to upgrade premium plan contact the owner.'
      ...
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/Gl0eUl2rkyq4Z06QlxfBSH'
   } else {
      global.db.setting = {
         autodownload: false,
         debug: false,
